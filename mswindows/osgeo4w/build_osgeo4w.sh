...
export CPPFLAGS="-I/c/Program Files (x86)/Microsoft Visual Studio/2019/Enterprise/VC/Tools/MSVC/14.29.30133/include -I/c/msys64/mingw64/include/c++/10.3.0 -I/c/msys64/mingw64/include/c++ -I/c/msys64/mingw64/${ARCH}/include -I/c/msys64/mingw64/include -I${OSGEO4W_ROOT_MSYS}/include -I${SRC}/dist.${ARCH}/include -I/usr/include"
