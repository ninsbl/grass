...
expected="10
10"
out=$(v.category option=print layer=2 input=vedit_test | tr -d '\r')  # Remove Windows line breaks
...
expected="1
2"
out=$(v.category option=print layer=1 input=vedit_test | tr -d '\r')  # Remove Windows line breaks
